...
All `.paperkit/` assets have been updated to incorporate comprehensive academic integrity principles centered around proper citation practices, reputable sources, and ethical research conduct.
...
- `.paperkit/_cfg/agents/research-consolidator.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/section-drafter.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/reference-manager.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/quality-refiner.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/paper-architect.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/latex-assembler.yaml` - ⚠️ Not modified (assembly focus)

### Specialist Agent Definitions (YAML)

- `.paperkit/_cfg/agents/librarian.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/tutor.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/brainstorm.yaml` - ✅ Updated
- `.paperkit/_cfg/agents/problem-solver.yaml` - ✅ Updated

### Core Agent Markdown Files

- `.paperkit/core/agents/research-consolidator.md` - ✅ Updated
- `.paperkit/core/agents/section-drafter.md` - ✅ Updated
- `.paperkit/core/agents/reference-manager.md` - ✅ Updated
- `.paperkit/core/agents/quality-refiner.md` - ⚠️ Deferred (YAML version is authoritative)
- `.paperkit/core/agents/paper-architect.md` - ⚠️ Deferred (YAML version is authoritative)
- `.paperkit/core/agents/latex-assembler.md` - ⚠️ Not modified (assembly focus)

### Specialist Agent Markdown Files

- `.paperkit/specialist/agents/librarian.md` - ✅ Updated
- `.paperkit/specialist/agents/tutor.md` - ✅ Updated
- `.paperkit/specialist/agents/brainstorm.md` - ⚠️ Deferred (YAML version is authoritative)
- `.paperkit/specialist/agents/problem-solver.md` - ⚠️ Deferred (YAML version is authoritative)

### Workflow Definitions

- `.paperkit/_cfg/workflows/write-section.yaml` - ✅ Updated with verification steps
- `.paperkit/_cfg/workflows/validate-citations.yaml` - ✅ Enhanced description
- `.paperkit/_cfg/workflows/consolidate.yaml` - ⚠️ Inherits from agent principles
- `.paperkit/_cfg/workflows/search-sources.yaml` - ⚠️ Inherits from agent principles

### Documentation Files

- `.paperkit/_cfg/guides/harvard-citation-guide.md` - ✅ Added Academic Integrity Statement
- `.paperkit/docs/github-copilot-instructions.md` - ✅ Added Academic Integrity Requirements section
- `.paperkit/docs/codex-instructions.md` - ✅ Added Academic Integrity Requirements section

### Manifest Files

- `.paperkit/_cfg/agent-manifest.yaml` - ✅ Added Academic Integrity Notice
- `.paperkit/_cfg/workflow-manifest.yaml` - ✅ Added Academic Integrity Notice
