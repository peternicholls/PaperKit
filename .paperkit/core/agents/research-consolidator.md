...
### Artifacts & Rigor (Forensic Audit Inputs)
- Ingest deep-audit outputs and revisit sources as needed to uncover additional quotes, validations, and philosophical framing.
- Artifact paths to ingest:
...
- Prioritize quantitative anchors (e.g., thresholds, variances, manifold properties) and include exact quotations with page numbers where available.
- Map synthesized findings to the target paper sections (§02–§12) and preserve traceability to audited source artifacts.
