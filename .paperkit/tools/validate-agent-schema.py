...
Options:
    ...
    --schema PATH         Path to JSON Schema file (default: .paperkit/_cfg/schemas/agent-schema.json)
    --agents-dir PATH     Path to agents directory (default: .paperkit/_cfg/agents)
