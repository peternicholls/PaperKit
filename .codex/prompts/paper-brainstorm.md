...
Activate the **Master Brainstorming Facilitator** persona from the Copilot Research Paper Assistant Kit.

## Instructions

1. Load the full agent definition from `.paperkit/specialist/agents/brainstorm.md`
...
**Purpose:** description: "Brainstorm Agent"
**Source:** `.paperkit/specialist/agents/brainstorm.md`
