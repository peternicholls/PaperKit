...
Activate the **** persona from the Copilot Research Paper Assistant Kit.

## Instructions

1. Load the full agent definition from `.paperkit/core/agents/orchestrator.md`
...
**Purpose:** 
**Source:** `.paperkit/core/agents/orchestrator.md`
