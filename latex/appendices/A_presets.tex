...
\paragraph{\texttt{categorical}} Uses Categorical Mode (\S\ref{sec:categorical-mode}) to maximize perceptual distance between all color pairs. Essential for charts, legends, and any context where colors represent distinct categories that must be easily distinguished.
