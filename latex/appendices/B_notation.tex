...
\begin{tabular}{lll}
  ...
  $(L, a, b)$ & --- & A colour point in OKLab Cartesian coordinates \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{lll}
  ...
  $C$ & $[0, \sim 0.4]$ & Chroma: $C = \sqrt{a^2 + b^2}$ (colourfulness/saturation) \\
  $h$ & $[0, 2\pi)$ & Hue angle: $h = \mathrm{atan2}(b, a)$ (radians) \\
  $(L, C, h)$ & --- & A colour point in OKLCh cylindrical coordinates \\
  \bottomrule
\end{tabular}
\end{center}
