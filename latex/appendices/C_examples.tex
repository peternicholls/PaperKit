...
// Result: tonal variations centered on the anchor
...
Categorical Mode (\S\ref{sec:categorical-mode}) maximizes perceptual distance between all colors, essential for data visualization.
...
// Ideal for heatmaps, intensity visualizations
\end{lstlisting}
