...
% ------------------------------------------------------------------------------
\section{Scope Boundaries (Core vs.\ Caller)}
\label{sec:api-scope}
...
\textbf{Rationale:} Keeping the core lean enables production-grade performance (5.6M colors/second) and avoids bloating with features that vary by use case. Language bindings and applications can add these capabilities as needed.
...
% [To be written: ~200 words]
% Content: Production-grade performance metrics
% Key points:
...
%
% Implication:
%   - Enables real-time palette generation in interactive applications
%   - No precomputation or caching needed
