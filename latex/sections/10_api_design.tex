...
The engine is a \textbf{pure function} that transforms configuration into palette:
...
The guiding principle: the engine should do only what the caller cannot do themselves. Complexity belongs in construction, not in the public interface.
