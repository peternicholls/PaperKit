...
To address this fundamental mismatch, scientists have developed \emph{perceptually uniform} colour spaces where Euclidean distances correspond more closely to perceived colour differences. In such spaces, moving a given distance in any direction produces a change that observers judge to be of similar magnitude.
...
Compared to alternatives, OKLab offers an excellent balance:
...
A $\Delta E$ of approximately 1.0 in OKLab corresponds to a just-noticeable difference (JND) for an average observer under standard viewing conditions.
