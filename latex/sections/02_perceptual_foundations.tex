...
\begin{quote}
``The visibility threshold of smoothness, i.e., the maximum color difference between two successive colors that is allowed in order to perceive a temporal color transition as smooth, is about ten times smaller for lightness changes than for chroma or hue changes in CIELAB'' \citep[p.~3]{kong2021}, citing \citet{sekulovski2007}.
\end{quote}
...
\begin{quote}
``No main effect of the base color point on the thresholds for lightness changes was found for the chromatic color points\ldots\ This shows independence of the thresholds to changes in chromaticity and dependence on lightness'' \citep{sekulovski2007}.
\end{quote>
