...
\paragraph{Context Suitability.} Print and screen have different requirements. Callers must verify that generated palettes are suitable for their target medium, including:
\begin{itemize}
