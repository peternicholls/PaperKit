...
> Reference only: DO NOT EDIT THIS FILE. The **active** agent system for this repository is in `open-agents/`. Use that folder to run agents; use this document only to modify the pattern.
